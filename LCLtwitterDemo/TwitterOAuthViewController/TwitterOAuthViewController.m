...
NSString *client_id = @"0IddQMHlMkLfI4s6ShFEqqXPV";//0IddQMHlMkLfI4s6ShFEqqXPV//2sVEcZDhudTeScaMShpd3w
NSString *secret = @"r4jBwqnhWpdUyNrdxcjqVSMb0K7l6K3c92YsZXUVnCfwKo7eUm";//r4jBwqnhWpdUyNrdxcjqVSMb0K7l6K3c92YsZXUVnCfwKo7eUm//CVqonV4B8wDxSnwzzXCC2uhak8H22R1gXhbsCSF1400
NSString *callback = @"http://127.0.0.1/twitter/callback.php";
...
- (void)didReceiveuserdata:(OAServiceTicket*)ticket data:(NSData*)data {
    ...
    if (_accessToken) {
        [dic setValue:_accessToken forKey:@"_accessToken"];
    }
